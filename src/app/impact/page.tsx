    ...
    <>
      ...
      <section className="bg-forest py-16 text-[#EFF4EA] sm:py-24">
        <div className="mx-auto grid max-w-[1160px] items-center gap-10 px-5 sm:px-8 lg:grid-cols-[.95fr_1.05fr] lg:gap-16 lg:px-16">
          <Reveal>
            <span className="inline-flex items-center gap-2 text-[0.78rem] font-semibold uppercase tracking-[0.14em] text-shoot before:h-0.5 before:w-[22px] before:rounded-full before:bg-shoot before:content-['']">
              Notre impact
            </span>
            ...
            <Link
              href="/actualites"
              className="mt-7 inline-flex rounded-[13px] border-[1.5px] border-white/28 px-6 py-3.5 font-semibold text-white transition hover:border-shoot hover:bg-white/8"
            >
              Voir les actualités
            </Link>
          </Reveal>
